window.onload = function() {
  // Ambil semua elemen gambar di dalam PosterTop
  const posterTop = document.getElementById('PosterTop');
  const images = posterTop.querySelectorAll('img');
  
  // Simpan URL gambar ke dalam array
  const imageUrls = [];
  images.forEach((img) => {
    if (img.src) {
  ...
  // Menghapus semua elemen di bawah PosterTop
  while (posterTop.firstChild) {
